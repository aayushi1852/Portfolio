...
function Projects(props) {
    return (
        <section className={`container-fluid pt-5 ${'bg-' + props.bg}`}>
                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="row d-flex justify-content-between my-5">
                            <div className="card col-lg-3 col-md-5 col-12">
                        ...
                        <div className='row d-flex justify-content-between my-5'>
                            <div className="card col-lg-3 col-md-5 col-12">
                                <a href='https://aayushi1852.github.io/Aayushi-api-/' target={'_blank'}>
                                    <div className="card-header">
                                        <img src={img4} className={'my-2 rounded  mx-2'} height={'118'} />
                                    </div>
                            ...
                            <div className="card col-lg-3 col-md-5 col-12">
                                <a href='https://aayushi1852.github.io/javascriptgame-assignment/' target={'_blank'}>
                                    <div className="card-header">
                                        <img src={img5} className={'my-2 rounded'} height={'115'} />
                                    </div>
                                    <div className="card-body text-center h3">Space-X Number War Game</div>
                                </a>
                            </div>
                            <div className="card col-lg-3 col-md-5 col-12">
                                <a href='https://aayushi1852.github.io/wddm114-song-player/' target={'_blank'}>
                                    <div className="card-header">
                                        <img src={img6} className={'my-2 rounded'} height={'115'} />
                                    </div>
