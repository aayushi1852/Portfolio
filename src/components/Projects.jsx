...
function Projects(props) {
    return (
        <section className="container-fluid page" id='project'>
            <div className="container">
                <div className="row pt-5 mt-5 text-center">
                    <h1 className='pt-5 mt-3'>PROJECTS</h1>
                    <hr/>
                </div>
                <div className="row">
                        ...
                        <div className="row d-flex justify-content-between">
                            <div className="card my-5 col-lg-3 col-md-5 col-12">
                                <a href='https://aayushi1852.github.io/contact-app/' target={'_blank'}>
                                    <div className="card-header d-flex bg-white justify-content-center">
                                        <img src={img1} className={'my-2 rounded'} height={'105'} />
                                    </div>
                            ...
                            <div className="card my-5 col-lg-3 col-md-5 col-12">
                                <a href='https://aayushi1852.github.io/ASSIGNMENT1/' target={'_blank'}>
                                    <div className="card-header d-flex bg-white justify-content-center">
                                        <img src={img2} className={'my-2 rounded'} height={'105'} />
                                    </div>
                            ...
                            <div className="card my-5 col-lg-3 col-md-5 col-12">
                                <a href='https://aayushi1852.github.io/bootstrap-assignment/' target={'_blank'}>
                                    <div className="card-header  d-flex bg-white justify-content-center">
                                        <img src={img3} className={'my-2 rounded'} height={'105'} />
                                    </div>
                            ...
                            <div className="card my-5 col-lg-3 col-md-5 col-12">
                                <a href='https://aayushi1852.github.io/Aayushi-api-/' target={'_blank'}>
                                    <div className="card-header bg-white d-flex justify-content-center">
                                        <img src={img4} className={'rounded'} height={'105'} />
                                    </div>
